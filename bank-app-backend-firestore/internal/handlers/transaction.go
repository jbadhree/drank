...
func (h *TransactionHandler) GetTransactionByID(c *gin.Context) {
	...
	transaction, err := h.transactionService.GetTransactionByID(idStr)
	if err != nil {
...
func (h *TransactionHandler) GetTransactionsByAccountID(c *gin.Context) {
	...
	transactions, err := h.transactionService.GetTransactionsByAccountID(accountIDStr, limit, offset)
	if err != nil {
		c.JSON(http.StatusInternalServerError, ErrorResponse{Message: "Failed to get transactions: " + err.Error()})
		return
	}
